...
<head>
	...
	<link rel="stylesheet" type="text/css" href="aset-login/src/plugins/jquery-steps/jquery.steps.css">
...
<body class="login-page">
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="aset-login/vendors/images/register-page-img.png" alt="">
				</div>
					...
					<div class="register-box bg-white box-shadow border-radius-10">
						<div class="wizard-content">
							<form class="tab-wizard2 wizard-circle wizard" action="/register" method="post">
								@csrf
								<h5>Identitas Dasar</h5>
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row">
											<label class="col-sm-4 col-form-label " for="nama">Nama*</label>
											<div class="col-sm-8">
												<input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Masukan Nama Anda"  value="{{ old('nama') }}"  >
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label is-invalid" for="nim">Nomor Induk Mahasiswa</label>
											<div class="col-sm-8">
												<input type="text" name="nim" class="form-control @error('nim') is-invalid @enderror" id="nim" placeholder="xx.xx.xxxx"  value="{{ old('nim') }}">
												<div class="invalid-feedback">
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label is-invalid" for="nik">Nomor Induk Kependudukan</label>
											<div class="col-sm-8">
												<input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror" id="nik" placeholder="3176801991111004" value="{{ old('nik') }}">
												<div class="invalid-feedback">
													Silahkan Masukan Nik Anda.
												</div>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 col-form-label is-invalid" for="username">Username*</label>
											<div class="col-sm-8">
										...
										<div class="form-group row">
											<label class="col-sm-4 col-form-label is-invalid" for="password">Password*</label>
											<div class="col-sm-8">
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row">
											<label class="col-sm-4 col-form-label is-invalid" for="email" >Email*</label>
											<div class="col-sm-8">
												<input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id= "email" placeholder="contoh@gmail.com"  value="{{old('email')}}">
												<div class="invalid-feedback">
													Periksa Kembali Input Email anda
												</div>
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="text" name="tempatlahir" class="form-control @error('tempatlahir') is-invalid @enderror" id= "tempatlahir" placeholder="Kota Lahir Anda"  value="{{ old('tempatlahir') }}">
												<div class="invalid-feedback">
													Silahkan Masukan Tempat Lahir Anda.
												</div>
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="date" name="tanggallahir" class="form-control @error('tanggallahir') is-invalid @enderror" id="tanggallahir"  value=" {{old('tanggallahir') }}" >
												<div class="invalid-feedback">
										...
										<div class="form-group row align-items-center">
											...
											<!-- <div class="col-sm-8">
												<input type="text" name="jeniskelamin" class="form-control @error('jeniskelamin') is-invalid @enderror" id="jeniskelamin"  value=" {{old('jeniskelamin') }}" >
												<div class="invalid-feedback">
													Silahkan Masukan Jenis Kelamin Anda.
												</div>
											</div> -->
											<div class="col-sm-8">
												<div class="custom-control custom-radio custom-control-inline pb-0">
													<input type="radio" id="laki-laki" name="jeniskelamin" class="custom-control-input" value="Laki-laki" >
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<select class="form-control selectpicker" title="Pilih Prodi" name="prodi">
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										...
										<button class="w-100 btn btn-lg btn-primary mt-3" type="submit" id="sa-success"  >Register</button>
									</div>
								</section>
							</form>
						</div>
	...
	<script src="aset-login/src/plugins/jquery-steps/jquery.steps.js"></script>
	<script src="aset-login/vendors/scripts/steps-setting.js"></script>
