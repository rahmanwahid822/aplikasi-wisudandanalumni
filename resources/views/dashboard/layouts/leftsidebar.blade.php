<section>
        ...
        <aside id="leftsidebar" class="sidebar">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <form action="/logout" method="post">
                                @csrf
                                <button type="submit"  class=" btn btn-lg btn-primary mt-3" ><i class="material-icons">input</i></i>Sign Out</button>
                            </form>
                        </ul>
                    </div>
                </div>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2022 - 2023 <a href="javascript:void(0);">IT Amik- rahmanwahid822</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.0
                </div>
